...
def image_text_retrieval(input_query,n_results=5):
    ...
    retrieved = collection.query(query_texts=input_query, n_results=n_results)
    print(retrieved)
    return retrieved

def image_retrieval(query_image,n_results=5):
    ...
    retrieved = collection.query(query_images=[query_image], n_results=n_results)
    return retrieved
